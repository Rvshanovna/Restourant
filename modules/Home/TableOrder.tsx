      ...
      <div className="flex items-center justify-between containers mb-4">
        <div className="flex items-center justify-center">
          <form className="relative w-90 ml-5 bg-[#d3d1d6] rounded-[28px] p-8 shadow-md flex flex-col gap-6">
            <div className="absolute -top-8 left-15 w-20 h-20 bg-black rounded-full flex items-center justify-center text-white text-[30px]">🍴</div>
            <h2 className="text-[22px] font-semibold mt-6">Забронировать стол</h2>
            <input type="tel" placeholder="Ваш номер" className="w-full border-b border-gray-500 bg-transparent py-2 outline-none focus:bg-transparent focus:ring-0"/>
            ...
            <div className="relative">
              <input type="date" className="w-full border-b border-gray-500 bg-transparent py-2 outline-none focus:bg-transparent"/>
              </div>
              <div className="relative">
                <input type="time" className="w-full border-b border-gray-500 bg-transparent py-2 outline-none focus:bg-transparent"/>
              </div>
              <div className="relative">
                ...
                <FaChevronDown className="absolute right-3 top-3 text-gray-600 text-sm" />
              </div>
              <p className="text-[13px] text-blue-600 cursor-pointer">Выбрать место на карте</p>
              <button className="bg-black text-white py-3 rounded-lg text-[18px] hover:bg-gray-900 transition">Забронировать</button>
            </form>
        </div>
        <div>
